...
public class windowMainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AWESOME SAUCE QUIZ");

        jLabel2.setText("By: Anthony Zhang, Eric Donner, Theshihan Suntharampillai");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            if (windowQuiz == null) {
                windowQuiz = new windowQuiz(this);
            }
            
            windowQuiz.setVisible(true);
            this.setVisible(false);
    }//GEN-LAST:event_jButton1ActionPerformed

    // go to study sheet window
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (windowStudy == null) {
                windowStudy = new windowStudysheet(this);
            }
            
            windowStudy.setVisible(true);
            this.setVisible(false);
    }//GEN-LAST:event_jButton2ActionPerformed

    // EXIT BUTTON
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        System.exit(0); // stop program if user clicks exit
